                ...
                <div class="dt-card__body">
                    ...
                    <form id="form_filter" class="mb-5">
                        <div class="row">
                            ...
                            <x-forms.selectbox labelName="Sale Status" name="sale_status" col="col-md-3" class="selectpicker">
...
<script>
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                ...
                "data": function (data) {
                    ...
                    data.customer_id    = $('#form_filter #customer_id').val();
                    data.to_date        = $('#form_filter #to_date').val();
                    data.from_date      = $('#form_filter #from_date').val();
                    data.sale_status    = $('#form_filter #sale_status').val();
    ...
    *********************/
    ...
    let name = $(this).data('name');
    let row = table.row($(this).parent('tr'));
    let url = "{{ route('sale.change.status') }}";
