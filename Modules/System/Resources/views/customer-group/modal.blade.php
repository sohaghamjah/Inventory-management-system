        ...
        <form action="" id="store_or_update_form">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-forms.textbox labelName="Group Name" name="group_name" required="required" col="col-md-12" placeholder="Enter Group Name"/>
                    <x-forms.textbox labelName="Percentage(%)" name="percentage" col="col-md-12" placeholder="0.00"/>
                </div>
            </div>
            <!-- /modal body -->
