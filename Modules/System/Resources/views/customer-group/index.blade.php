...
<script>
    ...
    // ================Data Table show setup=============
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                ...
                "type": "POST",
                "data": function (data) {
                    data.group_name =$('#form_filter #group_name').val();
                    data._token = _token;
                }
            },
            "columnDefs": [{
    ...
    $(document).on('click', '#save_btn', function(){
        ...
        var url = "{{ route('customer-group.store.or.update') }}";
        ...
        if(id){
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#store_or_update_modal .modal-title').html('<i class="fas fa-edit"></i> <span>Edit '+data.group_name+'</span>');
