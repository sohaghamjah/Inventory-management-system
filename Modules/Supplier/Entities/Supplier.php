...
class Supplier extends BaseModel
{
    ...
    private function getDataTableQuery(){
        ...
        if(permission('supplier-bulk-delete')){
            $this->column_order = [null,'id','name','phone','company_name','vat_number','email','address','city','state','postal_code','country','status',null];
        }else{
            $this->column_order = ['id','name','phone','company_name','vat_number','email','address','city','state','postal_code','country','status',null];
        }
