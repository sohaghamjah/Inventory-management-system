...
<script>
    ...
    // ================Data Table show setup=============
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                ...
                "type": "POST",
                "data": function (data) {
                    data.customer_group_id =$('#form_filter #customer_group_id').val();
    ...
    $(document).on('click', '#save_btn', function(){
        ...
        var url = "{{ route('customer.store.or.update') }}";
    ...
    $(document).on('click', '.view_data', function () {
        ...
        if(id){
            $.ajax({
                ...
                $('#view_modal .modal-title').html('<i class="fas fa-edit"></i> <span>Customer Details</span>');
