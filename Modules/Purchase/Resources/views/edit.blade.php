                ...
                <div class="dt-card__body">
                    ...
                    <form id="purchase_form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="order_tax_rate_hidden" value="{{ $purchase->total_tax_rate }}">
                            ...
                            <div class="col-md-12 text-dark form-group">
                                <table class="table table-bordered" id="product-list">
                                         ...
                                         @if (!$purchase->purchaseProducts->isEmpty())
                                            @foreach ($purchase->purchaseProducts as $key => $purchase_product)
                                                <tr>
                                                    ...
                                                    <td><button type="button" class="edit-product btn btn-sm btn-primary mr-2" data-toggle="modal" data-target="#editModal"><i class="fas fa-edit"></i></button> <button type="button" class="btn btn-danger btn-sm remove-product"><i class="fas fa-trash"></i></button></td>
                                    ...
                                    <tfoot class="bg-primary">
                                        ...
                                        <th id="total_qty" class="text-center">{{ $purchase->total_qty }}</th>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="order_discount" id="order_discount" placeholder="Order Discount" value="{{ $purchase->order_discount }}">
                            </div>

                            <div class="col-md-4">
                                <label for="shipping_cost">Shipping Cost</label>
                                <input type="text" class="form-control" name="shipping_cost" id="shipping_cost" placeholder="Shipping Cost" value="{{ $purchase->shipping_cost }}">
                            </div>

                            <div class="col-md-12">
                                <label for="shipping_cost">Note</label>
                                <textarea class="form-control" name="note" id="note">{{ $purchase->note }}</textarea>
                            </div>
                            ...
                            <div class="col-md-12 form-group text-right">
                                ...
                                <button class="btn btn-primary btn-sm" type="button" id="save_btn">Update</button>
                            </div>
                        </div>
                    </form>
...
$(document).ready(function () {
   ...
   ***********************/
    ...
    ****************************/
    ...
    @if (!$purchase->purchaseProducts->isEmpty())
        var count = "{{ count($purchase->purchaseProducts) + 1 }}" ;
        @else 
        var count = 1;
    @endif
