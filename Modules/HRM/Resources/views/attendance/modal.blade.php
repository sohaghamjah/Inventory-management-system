        ...
        <form action="" id="store_or_update_form">
            ...
            <div class="modal-body">
                <div class="row">
                  ...
                  <x-forms.textbox labelName="Date" name="date" required="required" col="col-md-12" class="date" value="{{ date('Y-m-d') }}"/>
                  <x-forms.textbox labelName="Check In" name="check_in" required="required" col="col-md-12" class="time"/>
                  <x-forms.textbox labelName="Check Out" name="check_out" required="required" col="col-md-12" class="time"/>
                </div>
            </div>
            <!-- /modal body -->
